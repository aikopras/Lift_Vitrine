...
//            2023/12/31 AP Version 1.1 - Added some debugging. Renamed some variables
//
...
// #define MASK_SENSORS_CONNECTED 0b0000000000000001
#define MASK_SENSORS_CONNECTED 0b0000111111111111

// For debugging purposes we may send the status of individual sensors to the serial monitor
...
void loop() {
  ...
  if (myRS485.input()) {    toggleLed(LED_BLUE);
    ...
    // If one or more sensors are occupied: 1) LED yellow = ON and LED green = OFF
    if (result) {
